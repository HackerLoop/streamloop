...
const ChannelPointWebsocket = require('./twitch-pub-socket');
...
class ChannelPointHandler extends Handler {
   ...
   */
  init(channelId) {
    ChannelPointWebsocket.connect(channelId, this.onChannelPointMessage.bind(this));
  }
